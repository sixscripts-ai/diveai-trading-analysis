...
export const LogoIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="m19.071 4.929-14.142 14.142"/>
...
export const BrainCircuitIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 5a3 3 0 1 0-5.993.142"/><path d="M18 5a3 3 0 1 0-5.993.142"/><path d="M12 12a3 3 0 1 0-5.993.142"/><path d="M18 12a3 3 0 1 0-5.993.142"/><path d="M12 19a3 3 0 1 0-5.993.142"/><path d="M18 19a3 3 0 1 0-5.993.142"/><path d="M12 5a3 3 0 1 0 5.993.142"/><path d="M6 5a3 3 0 1 0 5.993.142"/><path d="M12 12a3 3 0 1 0 5.993.142"/><path d="M6 12a3 3 0 1 0 5.993.142"/><path d="M12 19a3 3 0 1 0 5.993.142"/><path d="M6 19a3 3 0 1 0 5.993.142"/><path d="m12 8.5 0 2"/><path d="m12 15.5 0 2"/><path d="m15.5 12 2 0"/><path d="m8.5 12 2 0"/><path d="m15.5 5 2 0"/><path d="m8.5 5 2 0"/><path d="m15.5 19 2 0"/><path d="m8.5 19 2 0"/></svg>
);
